...
for i=1:N3d
    ...
    plot3([(data_3d(i, 1)+data_3d(i, 1+3+3+3)+data_3d(i, 1+3+3))/3, (data_3d(i, 1)+data_3d(i, 1+3+3+3)+data_3d(i, 1+3+3))/3+0.1*data_3d(i, 1+7*3)],...
          [(data_3d(i, 2)+data_3d(i, 2+3+3+3)+data_3d(i, 2+3+3))/3, (data_3d(i, 2)+data_3d(i, 2+3+3+3)+data_3d(i, 2+3+3))/3+0.1*data_3d(i, 2+7*3)],...
          [(data_3d(i, 3)+data_3d(i, 3+3+3+3)+data_3d(i, 3+3+3))/3, (data_3d(i, 3)+data_3d(i, 3+3+3+3)+data_3d(i, 3+3+3))/3+0.1*data_3d(i, 3+7*3)], '-k')
